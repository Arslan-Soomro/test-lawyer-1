...
def ask_legal_assistant(query, chat_history):
    ...
    get_answer_template = [
        ("system", "אתה עוזר משפטי, אתה מקבל קצת ידע בנושא ושאלה. ענה על שאלת המשתמש רק אם זה ברור מהידע. אם אינך יכול למצוא או לחלץ מידע רלוונטי, הודע בתמציתיות למשתמש שאינך בטוח."),
        ("human",
